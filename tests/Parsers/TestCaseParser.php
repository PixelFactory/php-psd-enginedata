...
class TestCaseParser extends TestCase{
    ...
    {
        self::$parsers_data = file(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'parsers_data');

        $class_name = '\\Enginedata\\Parsers\\' . substr(static::class, 0, -4 );
